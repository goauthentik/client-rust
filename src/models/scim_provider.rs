...
pub struct ScimProvider {
    ...
    #[serde(rename = "auth_oauth_token_last_updated", deserialize_with = "Option::deserialize")]
    pub auth_oauth_token_last_updated: Option<chrono::DateTime<chrono::FixedOffset>>,
    #[serde(rename = "auth_oauth_token_expires", deserialize_with = "Option::deserialize")]
    pub auth_oauth_token_expires: Option<chrono::DateTime<chrono::FixedOffset>>,
    #[serde(rename = "auth_oauth_url_callback", deserialize_with = "Option::deserialize")]
    pub auth_oauth_url_callback: Option<String>,
    #[serde(rename = "auth_oauth_url_start", deserialize_with = "Option::deserialize")]
