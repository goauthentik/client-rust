...
pub struct NotificationRule {
    ...
    #[serde(rename = "destination_group_obj", deserialize_with = "Option::deserialize")]
...
impl NotificationRule {
    ...
    pub fn new(pk: uuid::Uuid, name: String, destination_group_obj: Option<models::Group>) -> NotificationRule {
        NotificationRule {
            pk,
            name,
            transports: None,
