...
**auth_oauth_token_last_updated** | Option<**chrono::DateTime<chrono::FixedOffset>**> |  | [readonly]
**auth_oauth_token_expires** | Option<**chrono::DateTime<chrono::FixedOffset>**> |  | [readonly]
**auth_oauth_url_callback** | Option<**String**> |  | [readonly]
**auth_oauth_url_start** | Option<**String**> |  | [readonly]
