...
**base_url** | Option<**String**> | Configure the base URL under which this authentik instance is reachable, e.g. https://authentik.company | [optional]
...
**flags** | Option<[**models::PatchedSettingsRequestFlags**](PatchedSettingsRequestFlags.md)> |  | [optional]
