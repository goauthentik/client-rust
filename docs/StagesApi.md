...
> models::AccountLockdownStage stages_account_lockdown_create(account_lockdown_stage_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**account_lockdown_stage_request** | [**AccountLockdownStageRequest**](AccountLockdownStageRequest.md) |  | [required] |

### Return type

[**models::AccountLockdownStage**](AccountLockdownStage.md)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**stage_uuid** | **uuid::Uuid** | A UUID string identifying this Account Lockdown Stage. | [required] |
...
> models::PaginatedAccountLockdownStageList stages_account_lockdown_list(deactivate_user, delete_sessions, name, ordering, page, page_size, revoke_tokens, search, self_service_completion_flow, set_unusable_password, stage_uuid)
...
**self_service_completion_flow** | Option<**uuid::Uuid**> |  |  |
**set_unusable_password** | Option<**bool**> |  |  |
**stage_uuid** | Option<**uuid::Uuid**> |  |  |

### Return type

[**models::PaginatedAccountLockdownStageList**](PaginatedAccountLockdownStageList.md)
...
> models::AccountLockdownStage stages_account_lockdown_partial_update(stage_uuid, patched_account_lockdown_stage_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**stage_uuid** | **uuid::Uuid** | A UUID string identifying this Account Lockdown Stage. | [required] |
**patched_account_lockdown_stage_request** | Option<[**PatchedAccountLockdownStageRequest**](PatchedAccountLockdownStageRequest.md)> |  |  |
...
> models::AccountLockdownStage stages_account_lockdown_retrieve(stage_uuid)
...
> models::AccountLockdownStage stages_account_lockdown_update(stage_uuid, account_lockdown_stage_request)
...
> Vec<models::UsedBy> stages_account_lockdown_used_by_list(stage_uuid)
...
**auth_type** | Option<[**AuthTypeEnum**](AuthTypeEnum.md)> |  |  |
**configure_flow** | Option<**uuid::Uuid**> |  |  |
**friendly_name** | Option<**String**> |  |  |
...
**page** | Option<**i32**> | A page number within the paginated result set. |  |
**page_size** | Option<**i32**> | Number of results to return per page. |  |
**provider** | Option<[**ProviderEnum**](ProviderEnum.md)> |  |  |
**search** | Option<**String**> | A search term. |  |
**stage_uuid** | Option<**uuid::Uuid**> |  |  |
...
------------- | ------------- | ------------- | ------------- | -------------
**configure_flow** | Option<**uuid::Uuid**> |  |  |
**digits** | Option<[**DigitsEnum**](DigitsEnum.md)> |  |  |
**friendly_name** | Option<**String**> |  |  |
**name** | Option<**String**> |  |  |
**ordering** | Option<**String**> | Which field to use when ordering the results. |  |
**page** | Option<**i32**> | A page number within the paginated result set. |  |
...
**name** | Option<**String**> |  |  |
**not_configured_action** | Option<[**NotConfiguredActionEnum**](NotConfiguredActionEnum.md)> |  |  |
**ordering** | Option<**String**> | Which field to use when ordering the results. |  |
**page** | Option<**i32**> | A page number within the paginated result set. |  |
**page_size** | Option<**i32**> | Number of results to return per page. |  |
**search** | Option<**String**> | A search term. |  |
...
**page** | Option<**i32**> | A page number within the paginated result set. |  |
**page_size** | Option<**i32**> | Number of results to return per page. |  |
**resident_key_requirement** | Option<[**UserVerificationEnum**](UserVerificationEnum.md)> |  |  |
**search** | Option<**String**> | A search term. |  |
**user_verification** | Option<[**UserVerificationEnum**](UserVerificationEnum.md)> |  |  |
...
**mode** | Option<[**ConsentModeEnum**](ConsentModeEnum.md)> |  |  |
**name** | Option<**String**> |  |  |
**ordering** | Option<**String**> | Which field to use when ordering the results. |  |
**page** | Option<**i32**> | A page number within the paginated result set. |  |
**page_size** | Option<**i32**> | Number of results to return per page. |  |
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**cert_attribute** | Option<[**CertAttributeEnum**](CertAttributeEnum.md)> |  |  |
**certificate_authorities** | Option<[**Vec<uuid::Uuid>**](Uuid__Uuid.md)> |  |  |
**mode** | Option<[**StageModeEnum**](StageModeEnum.md)> |  |  |
**name** | Option<**String**> |  |  |
**ordering** | Option<**String**> | Which field to use when ordering the results. |  |
**page** | Option<**i32**> | A page number within the paginated result set. |  |
**page_size** | Option<**i32**> | Number of results to return per page. |  |
**search** | Option<**String**> | A search term. |  |
**stage_uuid** | Option<**uuid::Uuid**> |  |  |
**user_attribute** | Option<[**UserAttributeEnum**](UserAttributeEnum.md)> |  |  |
...
**search** | Option<**String**> | A search term. |  |
**r#type** | Option<[**PromptTypeEnum**](PromptTypeEnum.md)> |  |  |
...
**search** | Option<**String**> | A search term. |  |
**stage_uuid** | Option<**uuid::Uuid**> |  |  |
**user_creation_mode** | Option<[**UserCreationModeEnum**](UserCreationModeEnum.md)> |  |  |
**user_path_template** | Option<**String**> |  |  |
**user_type** | Option<[**UserTypeEnum**](UserTypeEnum.md)> |  |  |
