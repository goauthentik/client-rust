...
> models::ObjectAttribute core_object_attributes_create(object_attribute_request)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**object_attribute_request** | [**ObjectAttributeRequest**](ObjectAttributeRequest.md) |  | [required] |

### Return type

[**models::ObjectAttribute**](ObjectAttribute.md)
...
Name | Type | Description  | Required | Notes
------------- | ------------- | ------------- | ------------- | -------------
**attribute_id** | **uuid::Uuid** | A UUID string identifying this Object Attribute. | [required] |
...
> models::PaginatedObjectAttributeList core_object_attributes_list(enabled, object_type__app_label, object_type__model, ordering, page, page_size, search)
...
------------- | ------------- | ------------- | ------------- | -------------
**enabled** | Option<**bool**> |  |  |
**object_type__app_label** | Option<**String**> |  |  |
**object_type__model** | Option<**String**> |  |  |
**ordering** | Option<**String**> | Which field to use when ordering the results. |  |
**page** | Option<**i32**> | A page number within the paginated result set. |  |
**page_size** | Option<**i32**> | Number of results to return per page. |  |
**search** | Option<**String**> | A search term. |  |
...
[**models::PaginatedObjectAttributeList**](PaginatedObjectAttributeList.md)
...
> models::ObjectAttribute core_object_attributes_partial_update(attribute_id, patched_object_attribute_request)
...
------------- | ------------- | ------------- | ------------- | -------------
**attribute_id** | **uuid::Uuid** | A UUID string identifying this Object Attribute. | [required] |
**patched_object_attribute_request** | Option<[**PatchedObjectAttributeRequest**](PatchedObjectAttributeRequest.md)> |  |  |
...
> models::ObjectAttribute core_object_attributes_retrieve(attribute_id)
...
> models::ObjectAttribute core_object_attributes_update(attribute_id, object_attribute_request)
